...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__slider_with_arrows__ = __webpack_require__(622);
...
var SliderWithArrowsPage = (function () {
    ...
    SliderWithArrowsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-slider-with-arrows',template:/*ion-inline-start:"/Users/dspl/Documents/ionic/example/ionic3-components/src/pages/slide/slider-with-arrows/slider-with-arrows.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Slider with arrows</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-slides #slider effect="fade" (ionSlideWillChange)="onSlideChanged()">\n    <ion-slide *ngFor="let slide of slides"\n               class="swiper-no-swiping"\n               [ngStyle]="{\'background\' : \'url(\' + slide.imageUrl + \')\'}">\n      <h2>{{slide.title}}</h2>\n    </ion-slide>\n    <!-- Add Pagination -->\n    <div *ngIf="currentIndex > 0"\n         class="swiper-button-prev swiper-button-white"\n         (click)="previousSlide()"></div>\n    <div *ngIf="currentIndex < slides.length-1"\n         class="swiper-button-next swiper-button-white"\n         (click)="nextSlide()"></div>\n  </ion-slides>\n</ion-content>\n'/*ion-inline-end:"/Users/dspl/Documents/ionic/example/ionic3-components/src/pages/slide/slider-with-arrows/slider-with-arrows.html"*/
        }),
